import { Box, Flex, Text, Image, Stack, HStack, Input, VStack, Button, InputGroup, InputRightElement, Popover } from "@chakra-ui/react"
...
function SidePresentation() {
  ...
  return (
    <Flex id="leftSide" sx={backgroundImage} w="70vw" h="100vh">
      <Box mt={50} p="20">
        <Stack spacing={'10px'} >
          <HStack>
            <FifaHeaderComp />
          ...
          <Text width="30rem" as={'b'} color={'gray.50'} fontSize='2xl'>
